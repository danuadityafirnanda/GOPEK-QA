...
WebUI.takeFullPageScreenshot('Screenshots/REG012_02_AllFieldsEmpty.png')

WebUI.click(findTestObject('Auth/Register/btn_continue'))

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/REG012_03_ClientValidationError.png')
...
assert errorText.toLowerCase().contains('required')
