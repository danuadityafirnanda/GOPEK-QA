...
WebUI.takeFullPageScreenshot('Screenshots/LOG002_01_LoginPageLoaded.png')

WebUI.setText(findTestObject('Auth/Login/input_email'), 'invalid-email')

WebUI.setText(findTestObject('Auth/Login/input_password'), 'Password123!')

WebUI.takeFullPageScreenshot('Screenshots/LOG002_02_InvalidEmailFormatFilled.png')
