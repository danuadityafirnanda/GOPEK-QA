...
WebUI.takeFullPageScreenshot('Screenshots/REG013_01_RegisterPageLoaded.png')

WebUI.setText(findTestObject('Auth/Register/input_fullname'), 'Test User EmptyEmail')
...
WebUI.takeFullPageScreenshot('Screenshots/REG013_02_EmailEmpty.png')

WebUI.click(findTestObject('Auth/Register/btn_continue'))

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/REG013_03_AfterSubmit.png')
...
assert errorText.toLowerCase().contains('email') && errorText.toLowerCase().contains('required') : "Expected error about email being required but got: ${errorText}"

WebUI.takeFullPageScreenshot('Screenshots/REG013_04_ErrorShown.png')

String currentUrl = WebUI.getUrl()

assert currentUrl.contains('/register') : 'Should stay on register page when email is empty'
