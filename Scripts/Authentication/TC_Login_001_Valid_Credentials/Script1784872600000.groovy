...
WebUI.takeFullPageScreenshot('Screenshots/LOG001_01_LoginPageLoaded.png')
...
WebUI.takeFullPageScreenshot('Screenshots/LOG001_02_ValidCredentialsFilled.png')

WebUI.click(findTestObject('Auth/Login/btn_login'))

WebUI.waitForElementPresent(findTestObject('Common/toast'), 10)

WebUI.takeFullPageScreenshot('Screenshots/LOG001_03_SuccessToast.png')
...
WebUI.takeFullPageScreenshot('Screenshots/LOG001_04_RedirectToHome.png')
