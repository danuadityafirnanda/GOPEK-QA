...
WebUI.takeFullPageScreenshot('Screenshots/REG009_01_RegisterPageLoaded.png')

WebUI.setText(findTestObject('Auth/Register/input_fullname'), 'Test Password Mismatch')

WebUI.setText(findTestObject('Auth/Register/input_email_register'), 'pwdmismatch' + System.currentTimeMillis() + '@example.com')
...
WebUI.setText(findTestObject('Auth/Register/input_password_confirmation'), 'DifferentPass123!')

WebUI.takeFullPageScreenshot('Screenshots/REG009_02_PasswordMismatchFilled.png')
