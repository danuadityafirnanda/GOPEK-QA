...
WebUI.comment('=== TC_Fraud_004: Status Page Fraud Warning Visible - START ===')

// ============================================================
// CATATAN QA:
// Seed transaksi flagged via API (2 transfer beruntun), lalu
// verifikasi UI: buka halaman status /status/{id}?type=TRANSFER
...
// ========================================
// STEP 3: UI - Buka halaman status transaksi yang ter-flag fraud
// ========================================
WebUI.comment('Step 3: Open transaction status page (UI)')
WebUI.navigateToUrl(GlobalVariable.BASE_URL + '/status/' + flaggedTxId + '?type=TRANSFER')
WebUI.waitForPageLoad(10)
WebUI.delay(2)

// ========================================
// VALIDASI KUAT: Teks "Fraud Warning" + reason terlihat di halaman status
// ========================================
WebUI.comment('Step 4: Verify Fraud Warning text on status page')
...
assert isFraudWarningVisible : "Validation failed: 'Fraud Warning' text NOT visible on status page!"
...
assert isReasonVisible : "Validation failed: Fraud reason text NOT visible on status page!"

WebUI.comment('✅ PASS: Fraud Warning displayed on transaction status page')
WebUI.takeFullPageScreenshot('Screenshots/FRD004_StatusFraudWarning_Passed.png')

WebUI.comment('=== TC_Fraud_004 - COMPLETED ===')
