...
// ========================================
// SETUP TEST CASE - Withdraw Test Suite
// ========================================
...
WebUI.comment('TC_000_Setup_Login (Withdraw) - START')
...
WebUI.takeFullPageScreenshot('Screenshots/Withdraw_Setup_Login_Complete.png')

// ========================================
// SETUP COMPLETE
// ========================================
WebUI.comment('========================================')
WebUI.comment('✅ TC_000_Setup_Login (Withdraw) - COMPLETED')
WebUI.comment('✅ Browser is open and user is logged in')
WebUI.comment('✅ Ready for Withdraw test cases')
