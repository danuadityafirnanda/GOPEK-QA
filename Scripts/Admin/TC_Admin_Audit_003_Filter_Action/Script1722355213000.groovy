...
WebUI.takeFullPageScreenshot('Screenshots/Admin/Audit/AUD003_01_AuditPageLoaded.png')

// Apply filter: Action = FRAUD_DETECTED
...
// Type to search for "FRAUD_DETECTED" in dropdown
...
WebUI.takeFullPageScreenshot('Screenshots/Admin/Audit/AUD003_02_FilterApplied.png')
...
if (hasResults) {
    ...
    WebUI.comment('Filter by Action verified')
} else {
    WebUI.comment('No results found for filter - This is acceptable')
}

WebUI.takeFullPageScreenshot('Screenshots/Admin/Audit/AUD003_03_Verified.png')
