...
WebUI.takeFullPageScreenshot('Screenshots/TRF010_04_AccountValidated.png')

WebUI.click(findTestObject('Transfer/btn_continue_transfer'))

WebUI.takeFullPageScreenshot('Screenshots/TRF010_05_AmountPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF010_06_BackToAccountCheck.png')

String currentUrl = WebUI.getUrl()
assert currentUrl.contains('/transfer')

WebUI.verifyElementPresent(findTestObject('Transfer/input_account_number'), 5)
