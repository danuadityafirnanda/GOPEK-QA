...
WebUI.takeFullPageScreenshot('Screenshots/TRF021_01_LoginPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF021_02_Dashboard.png')

WebUI.navigateToUrl(GlobalVariable.BASE_URL + '/transfer')

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/TRF021_03_TransferPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF021_04_AccountValidated.png')

WebUI.click(findTestObject('Transfer/btn_continue_transfer'))

WebUI.takeFullPageScreenshot('Screenshots/TRF021_05_AmountPage.png')

WebUI.click(findTestObject('Common/btn_quick_amount_25000'))

WebUI.delay(1)

WebUI.takeFullPageScreenshot('Screenshots/TRF021_06_QuickAmountSelected.png')
...
assert amountValue == 'Rp 25.000'

WebUI.takeFullPageScreenshot('Screenshots/TRF021_07_AmountValidated.png')
