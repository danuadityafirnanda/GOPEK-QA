...
WebUI.takeFullPageScreenshot('Screenshots/TRF018_01_LoginPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF018_02_Dashboard.png')

WebUI.navigateToUrl(GlobalVariable.BASE_URL + '/transfer')

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/TRF018_03_TransferPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF018_04_AccountValidated.png')

WebUI.click(findTestObject('Transfer/btn_continue_transfer'))

WebUI.takeFullPageScreenshot('Screenshots/TRF018_05_AmountPage.png')

WebUI.click(findTestObject('Common/btn_quick_amount_250000'))

WebUI.delay(1)

WebUI.takeFullPageScreenshot('Screenshots/TRF018_06_QuickAmountSelected.png')
...
assert amountValue == 'Rp 250.000'

WebUI.takeFullPageScreenshot('Screenshots/TRF018_07_AmountValidated.png')
