...
WebUI.takeFullPageScreenshot('Screenshots/TRF002_01_LoginPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF002_02_DashboardAfterLogin.png')

WebUI.navigateToUrl(GlobalVariable.BASE_URL + '/transfer')

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/TRF002_03_TransferPage.png')

WebUI.setText(findTestObject('Transfer/input_account_number'), '9999999999')

WebUI.click(findTestObject('Transfer/btn_check_account'))

WebUI.delay(3)

WebUI.takeFullPageScreenshot('Screenshots/TRF002_04_InvalidAccountRedCard.png')
...
assert cardText.contains('not found') || cardText.contains('Account not found')
