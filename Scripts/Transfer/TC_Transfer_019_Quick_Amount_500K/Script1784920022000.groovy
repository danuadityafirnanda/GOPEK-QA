...
WebUI.takeFullPageScreenshot('Screenshots/TRF019_01_LoginPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF019_02_Dashboard.png')

WebUI.navigateToUrl(GlobalVariable.BASE_URL + '/transfer')

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/TRF019_03_TransferPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF019_04_AccountValidated.png')

WebUI.click(findTestObject('Transfer/btn_continue_transfer'))

WebUI.takeFullPageScreenshot('Screenshots/TRF019_05_AmountPage.png')

WebUI.click(findTestObject('Common/btn_quick_amount_500000'))

WebUI.delay(1)

WebUI.takeFullPageScreenshot('Screenshots/TRF019_06_QuickAmountSelected.png')
...
assert amountValue == 'Rp 500.000'

WebUI.takeFullPageScreenshot('Screenshots/TRF019_07_AmountValidated.png')
