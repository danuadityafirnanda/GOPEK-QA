...
WebUI.takeFullPageScreenshot('Screenshots/TRF020_01_LoginPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF020_02_Dashboard.png')

WebUI.navigateToUrl(GlobalVariable.BASE_URL + '/transfer')

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/TRF020_03_TransferPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF020_04_AccountValidated.png')

WebUI.click(findTestObject('Transfer/btn_continue_transfer'))

WebUI.takeFullPageScreenshot('Screenshots/TRF020_05_AmountPage.png')

WebUI.click(findTestObject('Common/btn_quick_amount_10000'))

WebUI.delay(1)

WebUI.takeFullPageScreenshot('Screenshots/TRF020_06_QuickAmountSelected.png')
...
assert amountValue == 'Rp 10.000'

WebUI.takeFullPageScreenshot('Screenshots/TRF020_07_AmountValidated.png')
