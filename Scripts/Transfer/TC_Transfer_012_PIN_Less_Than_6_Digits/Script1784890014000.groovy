...
WebUI.takeFullPageScreenshot('Screenshots/TRF012_01_LoginPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF012_02_Dashboard.png')

WebUI.navigateToUrl(GlobalVariable.BASE_URL + '/transfer')

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/TRF012_03_TransferPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF012_04_AccountValidated.png')

WebUI.click(findTestObject('Transfer/btn_continue_transfer'))

WebUI.takeFullPageScreenshot('Screenshots/TRF012_05_AmountPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF012_06_SummaryPage.png')

WebUI.click(findTestObject('Transfer/btn_continue_to_pin'))

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/TRF012_07_PINPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF012_08_OnlyThreeDigits.png')
...
assert submitDisabled : 'Submit button should be disabled when PIN is less than 6 digits'

String currentUrl = WebUI.getUrl()
assert currentUrl.contains('/transfer') : 'Should stay on transfer page when PIN incomplete'
