...
WebUI.takeFullPageScreenshot('Screenshots/TRF016_01_LoginPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF016_02_Dashboard.png')

WebUI.navigateToUrl(GlobalVariable.BASE_URL + '/transfer')

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/TRF016_03_TransferPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF016_04_AccountValidated.png')

WebUI.click(findTestObject('Transfer/btn_continue_transfer'))

WebUI.takeFullPageScreenshot('Screenshots/TRF016_05_AmountPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF016_06_SummaryPage.png')

WebUI.click(findTestObject('Transfer/btn_continue_to_pin'))

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/TRF016_07_PINPage.png')

WebUI.sendKeys(findTestObject('Transfer/input_pin_transfer'), 'ABCDEF')

WebUI.delay(1)

WebUI.takeFullPageScreenshot('Screenshots/TRF016_08_NonNumericInput.png')

String pinValue = WebUI.getAttribute(findTestObject('Transfer/input_pin_transfer'), 'value')
assert pinValue.isEmpty() || pinValue.matches('[0-9]*') : "PIN should only accept numeric input, but got: ${pinValue}"
...
assert submitDisabled : 'Submit button should be disabled with non-numeric PIN'
