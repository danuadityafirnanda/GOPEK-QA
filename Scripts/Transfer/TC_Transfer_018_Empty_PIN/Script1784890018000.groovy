...
WebUI.takeFullPageScreenshot('Screenshots/TRF018_06_SummaryPage.png')

WebUI.click(findTestObject('Transfer/btn_continue_to_pin'))

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/TRF018_07_PINPage.png')

WebUI.delay(1)

WebUI.takeFullPageScreenshot('Screenshots/TRF018_08_EmptyPIN.png')
