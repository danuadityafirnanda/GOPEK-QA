...
WebUI.takeFullPageScreenshot('Screenshots/TRF013_06_ZeroAmount.png')
...
assert errorText.toLowerCase().contains('minimum') || errorText.toLowerCase().contains('10') : "Expected error about minimum amount but got: ${errorText}"

WebUI.takeFullPageScreenshot('Screenshots/TRF013_07_ErrorShown.png')
