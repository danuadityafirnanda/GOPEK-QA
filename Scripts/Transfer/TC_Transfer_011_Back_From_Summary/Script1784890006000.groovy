...
WebUI.takeFullPageScreenshot('Screenshots/TRF011_06_SummaryPage.png')

WebUI.click(findTestObject('Transfer/btn_back_transfer_summary'))

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/TRF011_07_BackToAmountPage.png')

String currentUrl = WebUI.getUrl()
assert currentUrl.contains('/transfer')

WebUI.verifyElementPresent(findTestObject('Transfer/btn_continue_transfer'), 5)
