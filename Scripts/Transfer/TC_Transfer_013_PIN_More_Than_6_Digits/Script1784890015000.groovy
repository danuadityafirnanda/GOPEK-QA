...
WebUI.takeFullPageScreenshot('Screenshots/TRF013_01_LoginPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF013_02_Dashboard.png')

WebUI.navigateToUrl(GlobalVariable.BASE_URL + '/transfer')

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/TRF013_03_TransferPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF013_04_AccountValidated.png')

WebUI.click(findTestObject('Transfer/btn_continue_transfer'))

WebUI.takeFullPageScreenshot('Screenshots/TRF013_05_AmountPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF013_06_SummaryPage.png')

WebUI.click(findTestObject('Transfer/btn_continue_to_pin'))

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/TRF013_07_PINPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF013_08_SixDigitsEntered.png')

WebUI.verifyElementNotClickable(findTestObject('Transfer/btn_pin_digit_7'))

WebUI.delay(1)

WebUI.takeFullPageScreenshot('Screenshots/TRF013_09_AttemptSeventhDigit.png')
