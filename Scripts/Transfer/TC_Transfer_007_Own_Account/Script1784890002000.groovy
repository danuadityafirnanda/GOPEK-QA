...
WebUI.takeFullPageScreenshot('Screenshots/TRF007_01_LoginPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF007_02_Dashboard.png')

WebUI.navigateToUrl(GlobalVariable.BASE_URL + '/transfer')

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/TRF007_03_TransferPage.png')

WebUI.setText(findTestObject('Transfer/input_account_number'), GlobalVariable.TEST_USER_ACCOUNT)

WebUI.click(findTestObject('Transfer/btn_check_account'))

WebUI.delay(3)

WebUI.takeFullPageScreenshot('Screenshots/TRF007_04_OwnAccountRedCard.png')
