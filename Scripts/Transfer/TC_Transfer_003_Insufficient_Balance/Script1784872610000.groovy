...
WebUI.takeFullPageScreenshot('Screenshots/TRF003_01_LoginPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF003_02_Dashboard.png')

WebUI.navigateToUrl(GlobalVariable.BASE_URL + '/transfer')

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/TRF003_03_TransferPage.png')
...
WebUI.takeFullPageScreenshot('Screenshots/TRF003_04_AccountValidated.png')

WebUI.click(findTestObject('Transfer/btn_continue_transfer'))

WebUI.takeFullPageScreenshot('Screenshots/TRF003_05_AmountPage.png')

WebUI.setText(findTestObject('Common/input_amount_numeric'), '999999999')

WebUI.delay(2)

WebUI.takeFullPageScreenshot('Screenshots/TRF003_06_ExcessiveAmountEntered.png')

WebUI.waitForElementPresent(findTestObject('Common/error_amount_field'), 10)

WebUI.takeFullPageScreenshot('Screenshots/TRF003_07_InsufficientBalanceError.png')

String errorText = WebUI.getText(findTestObject('Common/error_amount_field'))

assert errorText.contains('Insufficient') || errorText.contains('balance')
